...
def funcoes_app():
    while True:
        ...
        print("2 - Consulte no cardapio")
        print("3 - Cadastrar pedido")
        print("4 - Listar informações buscadas")
...
#------------------------------------------------------------------------------------------
# editar pedido adicionar itens ao pedido já feito      
            ...
            for linha in cardapio:
                    ...
                    if int(id_sabor) == novosabor:
                        ...
                        with open("pedidos.txt", "a") as arquivo_pedidos:
                            ...
                            break
#------------------------------------------------------------------------------------------------
# editar pedido, remover itens do pedido da feito
